...
***Important :*** Pour faciliter votre compréhension de ce guide, vous devez préalablement vous êtres familiarisé.e avec les bases de la rédaction d'un script RMarkdown. Si ce n'est pas déjà fait, veuillez lire attentivement le document `script_rmarkdown.html` sur Studium.
